...
if (!function_exists("debug_log")) {
    function debug_log(string $msg, string $origem = "geral"): void {
...
if (!function_exists("json_response")) {
    function json_response(bool $sucesso, string $mensagem = "", $dados = null, int $httpCode = 200): void {
        http_response_code($httpCode);
        header("Content-Type: application/json; charset=utf-8");
        echo json_encode(resposta($sucesso, $mensagem, $dados), JSON_UNESCAPED_UNICODE);
        exit;
    }
}
